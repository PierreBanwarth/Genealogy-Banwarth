...
print(arbre[2]['nom'] +" "+arbre[2]['prenom'])

for key, value in arbre[2].items():
    print("Key = " +key + " => Value = "+value)


# fonction pour parcourir l'arbre (for i in arbre )
# for i in arbre:
#     # i est le numéro sosa 
#     # arbre[i] est l'enregistrement d'une personne
#    print(arbre[i]['nom'] + " " + arbre[i]['prenom'])

for i in arbre:
    if 'ageDonneDeces' in arbre[i]:
        print(arbre[i]['ageDonneDeces'])
